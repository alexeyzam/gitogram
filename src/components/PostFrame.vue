      ...
      >
        <template v-slot:icon>
          <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg" >
            <path fill-rule="evenodd" clip-rule="evenodd" :class="repoLiked?'liked-repo':'not-liked-repo'"
  ...
  methods:{
    ...
    async checkRepoStarred(){
      try {
        ...
        if (error.response.status==404){this.repoLiked=false}
